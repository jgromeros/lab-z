    ...
    <body>
		...
		<div class="layerder">
			<table align="center">
				<tr>
					<td>
						<form name="form" action="done.htm" method="post">
							<table align="center">
								<tr><td align="center">
								...
								<tr><td><table align="center">
									<tr>
										...
										<td>
											<input type="text" name="idnumber" value="${labcase.sender }"
													size="32" maxlength="16"/>
										</td>
										<td>Nombre:</td>
										<td>
											<input type="text" name="name" value="${labcase.sender }"
									...
									<tr>
										...
										<td>
											<input type="text" name="address" value="${labcase.sender }"
													size="32" maxlength="255"/>
										</td>
										<td>Tel&eacute;fono:</td>
										<td>
											<input type="text" name="phone" value="${labcase.sender }"
													size="32" maxlength="16"/>
										</td>
									</tr>
									<tr>
										...
										<td>
											<input type="text" name="email" value="${labcase.sender }"
